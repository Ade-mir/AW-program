...
testCase('Properties', {
  ...
  'Accessing properties (1)': function () {
    ...
    assert(
      person.driveCar() == 'Frank drives his Volvo at the ripe age of 33',
      '9'
    );
  },
  ...
  'Adding/changing properties': function () {
    ...
    hero.items.unshift({ name: 'Sword of fury', type: 'weapon', color: 'red' });
    hero.items[1].color = 'green';
    hero.items[1].name = 'Wild apple';
    hero.attacks[0].damage = [50, 40, 30];
    hero.attacks[1].damage = [75];
  ...
  'Which properties do I have?': function () {
    ...
    var attackProperties = Object.keys(hero.attacks[1]);

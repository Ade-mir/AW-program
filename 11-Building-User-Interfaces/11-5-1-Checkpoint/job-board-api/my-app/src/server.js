...
const jobs = [
  {
    ...
    description:
      "Are you our next star? We're looking for someone to help us transform our business and build our new solutions",
  },
  {
    id: '2',
    createdAt: '2019-12-12T21:36:05.887Z',
...
app.post('/jobs', function (req, res) {
  const { title, email, homepage, company, description } = req.body;
...
app.put('/jobs/:id', function (req, res) {
  const { id, title, email, homepage, company, description } = req.body;
